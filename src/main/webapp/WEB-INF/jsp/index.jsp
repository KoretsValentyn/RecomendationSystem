		...
		<div class="book book-1">
			<div class="cover">
				<div class="desc">
					...
					<p>Assumenda nostrum deserunt doloribus delectus veritatis assumenda minus. Similique optio illum consequatur reiciendis asperiores consequatur quo.</p>
					<p>Consequatur qui quis ipsum quia voluptatem enim dignissimos vero.</p>
			...
			<div class="rating">
				...
				<input type="radio" name="rating-1" value="2" id="star-1-2"><label for="star-1-2">2</label>
				<input type="radio" name="rating-1" value="3" id="star-1-3"><label for="star-1-3">3</label>
				<input type="radio" name="rating-1" value="4" id="star-1-4"><label for="star-1-4">4</label>
				<input type="radio" name="rating-1" value="5" id="star-1-5"><label for="star-1-5">5</label>
				<input type="radio" name="rating-1" value="6" id="star-1-6"><label for="star-1-6">6</label>
				<input type="radio" name="rating-1" value="7" id="star-1-7"><label for="star-1-7">7</label>
				<input type="radio" name="rating-1" value="8" id="star-1-8"><label for="star-1-8">8</label>
				<input type="radio" name="rating-1" value="9" id="star-1-9"><label for="star-1-9">9</label>
				<input type="radio" name="rating-1" value="10" id="star-1-10"><label for="star-1-10">10</label>
			</div>
		</div>
